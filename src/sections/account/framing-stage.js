...
export default function AccountNotifications({ data, client_id }) {
  ...
  const handleStageChange = (event) => {
    ...
    if (newData.framing_inspection && newData.framing_inspection[0]) {
      newData.framing_inspection[0] = {
        ...newData.framing_inspection[0],
      ...
      console.log('ONCHANHE', currentClientData.framing_inspection[0]);
  ...
  const onSubmit = handleSubmit(async (values) => {
    ...
    const res = await fetch('http://127.0.0.1:8000/client/update-framing/', requestOptions);
  ...
  return currentClientData.current_stage > 1 ? (
              ...
              >
                ...
                <Box sx={{ p: 1, borderRadius: 2, bgcolor: 'background.neutral' }}>
                  ...
                  <FormControlLabel
                    ...
                    control={
                      <Switch
                        checked={currentClientData?.framing_inspection?.[0]?.is_completed}
                        ...
                        <FormControlLabel
                          ...
                          control={
                            <Switch
                              ...
                              checked={currentClientData?.framing_inspection?.[0]?.[item.id]}
