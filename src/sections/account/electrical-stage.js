...
export default function AccountNotifications({ data, client_id }) {
  ...
  const handleStageChange = (event) => {
    ...
    if (newData.electrical_inspection && newData.electrical_inspection[0]) {
      newData.electrical_inspection[0] = {
        ...newData.electrical_inspection[0],
      ...
      console.log('ONCHANHE', currentClientData.electrical_inspection[0]);
  ...
  const onSubmit = handleSubmit(async (values) => {
    ...
    const res = await fetch('http://127.0.0.1:8000/client/update-electrical/', requestOptions);
  ...
  return currentClientData.current_stage > 2 ? (
              ...
              >
                ...
                <Box sx={{ p: 1, borderRadius: 2, bgcolor: 'background.neutral' }}>
                  ...
                  <FormControlLabel
                    ...
                    control={
                      <Switch
                        checked={currentClientData?.electrical_inspection?.[0]?.is_completed}
                        ...
                        <FormControlLabel
                          ...
                          control={
                            <Switch
                              ...
                              checked={currentClientData?.electrical_inspection?.[0]?.[item.id]}
                              ...
                              onChange={(event, checked) => {
                                ...
                                if (
                                  ...
                                  console.log(
                                    'ONCHANHE',
                                    currentClientData.electrical_inspection[0]
                                  );
                                  console.log('ONCHAGE VALUES', values.selected);
                                }
                              }}
