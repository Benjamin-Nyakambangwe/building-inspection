...
export default function AccountNotifications({ data, client_id }) {
  ...
  const handleStageChange = (event) => {
    ...
    if (newData.final_inspection && newData.final_inspection[0]) {
      newData.final_inspection[0] = {
        ...newData.final_inspection[0],
      ...
      console.log('ONCHANHE', currentClientData.final_inspection[0]);
  ...
  const onSubmit = handleSubmit(async (values) => {
    ...
    const res = await fetch('http://127.0.0.1:8000/client/update-final/', requestOptions);
  ...
  return currentClientData.current_stage > 7 ? (
              ...
              >
                ...
                <Box sx={{ p: 1, borderRadius: 2, bgcolor: 'background.neutral' }}>
                  ...
                  <FormControlLabel
                    ...
                    control={
                      <Switch
                        checked={currentClientData?.final_inspection?.[0]?.is_completed}
                        ...
                        <FormControlLabel
                          ...
                          control={
                            <Switch
                              ...
                              checked={currentClientData?.final_inspection?.[0]?.[item.id]}
