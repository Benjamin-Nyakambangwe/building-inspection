  ...
  return (
    <FormProvider methods={methods} onSubmit={onSubmit}>
      <Stack spacing={3} sx={{ px: 3 }}>
        <RHFTextField name="inspector" label="Inspector" value={currentEvent?.title} />
        <RHFTextField name="client" label="Client" value={currentEvent?.client} />
        <RHFTextField name="phone" label="Phone" value={currentEvent?.phone} />
        <RHFTextField name="location" label="Location" value={currentEvent?.location} />
        ...
        <RHFSwitch name="allDay" label="All day" value={true} />
